...
class drawResultPlot6:
    ...
    def drawResultPlot(
        ...
        ax.grid()
        #        print("y = [{}]".format(y))
        #        cs_lable = ['or','vr','^r','<r','>r','1r','2r',
        #                    '3r','4r','sr','pr','*r','hr','Hr','+r','xr']
        cs_label = ["or", "vb", "^g"]
        plt.xlim(0, 30)
        plt.ylim(0, 1)
        #      define variable
        ...
        # plt.plot(sf2_frequency,N_ucn_norm_time_offset_10,cs_label[1],
        # label = 'time_offset 10s',linestyle='-',linewidth=2.0)
        # plt.plot(sf2_frequency,N_ucn_norm_time_offset_20,cs_label[2],
...
Obj_drawResultPlot6 = drawResultPlot6(
    A.TABLE_NAME_13,
    A.TABLE_NAME_14,
    A.TABLE_NAME_15,
    A.TABLE_NAME_21,
